...
const september16EveningStories: Story[] = [
  {
...
const september16EveningGraphNodes: GraphNode[] = [
...
const september16EveningGraphLinks: GraphLink[] = [
...
const september16NightStories: Story[] = [
  {
...
const september16NightGraphNodes: GraphNode[] = [
...
const september16NightGraphLinks: GraphLink[] = [
...
const september15Stories: Story[] = [
  {
...
const september15GraphNodes: GraphNode[] = [
...
const september15GraphLinks: GraphLink[] = [
...
const september13Stories: Story[] = [
  {
...
const september13GraphNodes: GraphNode[] = [
...
const september13GraphLinks: GraphLink[] = [
...
const september11NightStories: Story[] = [
  {
...
const september11NightGraphNodes: GraphNode[] = [
...
const september11NightGraphLinks: GraphLink[] = [
...
const september10NoonStories: Story[] = [
  {
...
export const archivedEditions = [
  {
    ...
    stories: september16EveningStories,
  },
  {
    pulse: 'NIGHT_RUN_16',
    publishedDate: '2026-09-16',
    publishedLabel: 'September 16, 2026',
    stories: september16NightStories,
  },
  {
    pulse: 'CATCHUP_RUN_15',
    publishedDate: '2026-09-15',
    publishedLabel: 'September 15, 2026',
    stories: september15Stories,
  },
  {
    pulse: 'NOON_RUN_13',
    publishedDate: '2026-09-13',
    publishedLabel: 'September 13, 2026',
    stories: september13Stories,
  },
  {
    pulse: 'NIGHT_RUN_11',
    publishedDate: '2026-09-11',
    publishedLabel: 'September 11, 2026',
    stories: september11NightStories,
  },
  {
    pulse: 'NOON_RUN_10',
    publishedDate: '2026-09-10',
    publishedLabel: 'September 10, 2026',
    stories: september10NoonStories,
  },
  {
    pulse: 'NIGHT_RUN_10',
    publishedDate: '2026-09-10',
...
const september10NoonGraphNodes: GraphNode[] = [
...
const september10NoonGraphLinks: GraphLink[] = [
...
export const archivedGraphNodes: GraphNode[] = [...september16EveningGraphNodes, ...september16NightGraphNodes, ...september15GraphNodes, ...september13GraphNodes, ...september11NightGraphNodes, ...september10NoonGraphNodes, ...september10NightGraphNodes, ...september9NoonGraphNodes, ...september9NightGraphNodes, ...september8GraphNodes, ...september7GraphNodes, ...september4GraphNodes, ...september3GraphNodes, ...september2GraphNodes];
export const archivedGraphLinks: GraphLink[] = [...september16EveningGraphLinks, ...september16NightGraphLinks, ...september15GraphLinks, ...september13GraphLinks, ...september11NightGraphLinks, ...september10NoonGraphLinks, ...september10NightGraphLinks, ...september9NoonGraphLinks, ...september9NightGraphLinks, ...september8GraphLinks, ...september7GraphLinks, ...september4GraphLinks, ...september3GraphLinks, ...september2GraphLinks];
